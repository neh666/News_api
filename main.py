...
class NewsApp:
    ...
    def __init__(self):
        ...
        # fetch data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=9184030c4df1410d8a52b61a4558d1ec').json()
        # initial GUI load
        self.load_gui()
    ...
    def load_gui(self):
        ...
        self.root.title('Digi Newspaper')
    ...
    def load_news_item(self,index):
        ...
        try:
            ...
            img_url = 'https://macreports.com/wp-content/uploads/2020/06/cannot-load-photo.png'
            raw_data = urlopen(img_url).read()
            im = Image.open(io.BytesIO(raw_data)).resize((350, 250))
            photo = ImageTk.PhotoImage(im)
